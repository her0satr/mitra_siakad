...
function PTSav() {
  ...
  if ($md == 0) {
    $s = "update asalsekolah set Nama='$Nama', Alamat1='$Alamat1', Alamat2='$Alamat2',
      ...
      where Perguruan TinggiID='$PerguruanTinggiID'";
    $r = _query($s);
  }
  else {
    $ada = GetFields('asalsekolah', 'PerguruanTinggiID', $PerguruanTinggiID, '*');
    if (!empty($ada)) echo ErrorMsg("Data tidak dapat disimpan",
      ...
      $s = "insert into asalsekolah (PerguruanTinggiID, Nama, JenisPerguruanTinggiID, Alamat1, Alamat2, Kota, KodePos, NA,
