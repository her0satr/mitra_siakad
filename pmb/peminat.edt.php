...
// link default => http://localhost/siakad/trunk/pmb/peminat.edt.php?gel=S1-KEP-13-GEL1&md=1&id=0&_rnd=6opGADT1
...
function fnEdit() {
	...
	if (empty($g) || $g['NA'] == 'Y') {
		die(ErrorMsg("Error", "Gelombang tidak ditemukan atau sudah tidak aktif.<br />Hubungi Sysadmin untuk informasi lebih lanjut.<hr size=1 color=silver /><input type=button name='btnClose' value='Tutup' onClick='window.close()' />"));
	}
  ...
  if ($md == 0) {
	...
	die(ErrorMsg("Error", "Mode edit <b>$md</b> tidak dikenali oleh sistem.<br />Hubungi Sysadmin untuk informasi lebih lanjut. <hr size=1 color=silver /> <input type=button name='btnClose' value='Tutup' onClick='window.close()' />"));
  }
...
ESD;
  ...
  <tr style="display: none;"><td class=inp>Catatan Presenter: </td>
	  <td class=ul1>
