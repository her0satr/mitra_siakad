<?php
	...
	{	TampilkanJudul("Pembagian Kelas");
		...
		echo  "<Iframe name='frame1' src='$_SESSION[mnux].frame1.php' align=left width=35.5% height=1500 frameborder=0></Iframe>";

		echo "<Iframe name='frame2' src='$_SESSION[mnux].frame2.php' align=right width=50.5% height=1500 frameborder=0></Iframe>";
	}
