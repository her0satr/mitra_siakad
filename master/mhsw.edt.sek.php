...
function frmSekolah() {
  ...
  <tr><td class=inp rowspan=2>Sekolah Asal</td><td class=ul><input type=text name='AsalSekolah' value='$datamhsw[AsalSekolah]' size=10 maxlength=50></td></tr>
  <tr><td class=ul><input type=text name='NamaSekolah' value='$NamaSekolah' size=40 maxlength=50> <a href='javascript:carisekolah(data)'>Cari</a></td></tr>
